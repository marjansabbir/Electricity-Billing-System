...
import javax.swing.*;
 ...
 public class MeterInfo extends JFrame implements ActionListener {
    ...
    private static final String METER_INFO_FILE = "C:\\Users\\marja\\Desktop\\Java Project 5\\JAVA PROJECT\\Electricity Billing System\\meter_info.txt";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            // Save meter information to the file
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(METER_INFO_FILE, true))) {
                writer.write(meter + "," + location + "," + type + "," + code + "," + typebill + "," + days);
                writer.newLine();
