...
//             String customerData = name + "," + meter + "," + address + "," + city + "," + state + "," + email + "," + phone + "\n";

            
//             saveCustomerDataToFile(customerData);
...
//     private void saveCustomerDataToFile(String customerData) {
...
//         try (FileWriter fw = new FileWriter(customerFile, true)) { 
//             fw.write(customerData);
//         } catch (IOException e) {
//             e.printStackTrace();
//         }
...
//         try (FileWriter fw = new FileWriter(customerFile, true)) {
//             fw.write(customerData);
//             System.out.println("Customer Data Written to File: " + customerData);
//         } catch (IOException e) {
//             e.printStackTrace();
//         }
//     }
